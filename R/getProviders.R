...
#' @param lat The latitude of the location of interest
#' @param long The longitude of the location of interest
#' @param zip The zipcode of the location of interest; an optional parameter when coordinates are not known
